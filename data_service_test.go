...
func TestData_MissingFeed(t *testing.T) {
	...
	mux.HandleFunc("/api/v2/feeds/temperature/data",
...
func TestDataSend(t *testing.T) {
	...
	// prepare endpoint URL for just this request
	mux.HandleFunc("/api/v2/feeds/temperature/data/send",
		func(w http.ResponseWriter, r *http.Request) {
			testMethod(t, r, "POST")
			fmt.Fprint(w, `{"id":1, "value":"67.112"}`)
		},
...
func TestDataGet(t *testing.T) {
	...
	// prepare endpoint URL for just this request
	mux.HandleFunc("/api/v2/feeds/temperature/data/1",
		func(w http.ResponseWriter, r *http.Request) {
			testMethod(t, r, "GET")
			fmt.Fprint(w, `{"id":1, "value":"67.112"}`)
		},
...
func TestDataDelete(t *testing.T) {
	...
	mux.HandleFunc("/api/v2/feeds/test/data/1",
		func(w http.ResponseWriter, r *http.Request) {
...
func TestDataQueue(t *testing.T) {
	...
	// prepare endpoint URL for just this request
	mux.HandleFunc("/api/v2/feeds/temperature/data/next",
		func(w http.ResponseWriter, r *http.Request) {
			testMethod(t, r, "GET")
	...
	mux.HandleFunc("/api/v2/feeds/temperature/data/prev",
		func(w http.ResponseWriter, r *http.Request) {
			testMethod(t, r, "GET")
	...
	mux.HandleFunc("/api/v2/feeds/temperature/data/last",
		func(w http.ResponseWriter, r *http.Request) {
			testMethod(t, r, "GET")
